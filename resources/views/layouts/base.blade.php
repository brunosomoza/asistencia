...
<!-- Mirrored from themicon.co/theme/angle/v4.7.8/static-html/app/template.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2020 00:41:09 GMT -->
<head>
   <meta charset="utf-8">
   ...
   <!-- FONT AWESOME-->
   <link rel="stylesheet" href="{{ asset('plantilla/vendor/%40fortawesome/fontawesome-free/css/brands.css') }} ">
   <link rel="stylesheet" href="{{ asset('plantilla/vendor/%40fortawesome/fontawesome-free/css/regular.css') }} ">
   <link rel="stylesheet" href="{{ asset('plantilla/vendor/%40fortawesome/fontawesome-free/css/solid.css') }} ">

   <link rel="stylesheet" href="{{ asset('plantilla/vendor/%40fortawesome/fontawesome-free/css/fontawesome.css') }} ">

   <link rel="stylesheet" href="{{ asset('plantilla/vendor/simple-line-icons/css/simple-line-icons.css') }} ">
   <link rel="stylesheet" href="{{ asset('plantilla/vendor/animate.css/animate.css') }} ">
   <link rel="stylesheet" href="{{ asset('plantilla/vendor/whirl/dist/whirl.css') }} ">

 
   <link rel="stylesheet" href="{{ asset('plantilla/css/bootstrap.css') }}" id="bscss">
   <link rel="stylesheet" href="{{ asset('plantilla/css/bootstrap.css') }} " id="bscss"><!-- =============== APP STYLES ===============-->
   
   <link rel="stylesheet" href="{{ asset('plantilla/css/app.css') }}" id="bscss">
...
<body>
      ...
      <header class="topnavbar-wrapper">
         ...
         <nav class="navbar topnavbar">
            ...
            <div class="navbar-header"><a class="navbar-brand" href="#/">
                  <div class="brand-logo"><img class="img-fluid" src="{{ asset('plantilla/img/logo.png') }}" alt="App Logo"></div>
            ...
            <!-- START Search form-->
            <form class="navbar-form" role="search" action="http://themicon.co/theme/angle/v4.7.8/static-html/app/search.html">
   ...
   <!-- MODERNIZR-->
   <script src="{{ asset('plantilla/vendor/modernizr/modernizr.custom.js') }} "></script><!-- STORAGE API-->
   <script src="{{ asset('plantilla/vendor/js-storage/js.storage.js') }}"></script><!-- SCREENFULL-->
   <script src="{{ asset('plantilla/vendor/screenfull/dist/screenfull.js') }}"></script><!-- i18next-->
   <script src="{{ asset('plantilla/vendor/i18next/i18next.js') }}"></script>
   <script src="{{ asset('plantilla/vendor/i18next-xhr-backend/i18nextXHRBackend.js') }}"></script>
   <script src="{{ asset('plantilla/vendor/jquery/dist/jquery.js') }}"></script>
   <script src="{{ asset('plantilla/vendor/popper.js/dist/umd/popper.js') }}"></script>
   <script src="{{ asset('plantilla/vendor/bootstrap/dist/js/bootstrap.js') }}"></script><!-- =============== PAGE VENDOR SCRIPTS ===============-->
   <!-- =============== APP SCRIPTS ===============-->
